                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-1">
                      ...
                      <p class="nda-desc">
                        ...
                        <span class="block mt-1 opacity-75 leading-tight">
                          ...
                          below visualize the core engineering architecture and data governance
                          logic.
                        </span>
                      </p>
                    </div>
                  ...
                  >
                    <div
                      ...
                      :class="
                        activeTabContent.mode === 'tech' ? 'box-mode-tech' : 'box-mode-gallery'
                      "
                    >
